...
function CustomDegradationSection({
  ...
  return (
    <div className="space-y-1.5">
      ...
      <p className="text-[9px] text-muted-foreground leading-relaxed">
        Mescole con degrado <strong className="text-red-400">Invalido</strong>. L'inserimento è opzionale: se lasci i campi vuoti, verranno utilizzati automaticamente i valori di fallback stimati dal sistema.
      </p>
      <div className="space-y-1.5">
