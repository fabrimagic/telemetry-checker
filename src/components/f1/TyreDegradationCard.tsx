  ...
  return (
    <div className="bg-card rounded-lg border border-border p-4 space-y-4">
      ...
      <div className="flex items-start gap-2 text-[11px] text-muted-foreground bg-muted/40 rounded-md px-3 py-2">
        ...
        <span>
          Il degrado indica di quanti secondi per giro peggiora mediamente il passo con l'aumentare dell'età della gomma. Un valore più alto indica un decadimento prestazionale più rapido.
        </span>
      </div>
