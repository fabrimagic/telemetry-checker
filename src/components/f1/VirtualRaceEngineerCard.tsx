            ...
            <div className="flex items-start gap-2">
              ...
              <span className="text-[11px] font-semibold text-foreground">{getPhaseLabel(race_phase.current_phase)}</span>
                ...
                <p className="text-[10px] text-muted-foreground/70 mt-1 leading-relaxed italic">
                  ℹ️ La <strong className="text-muted-foreground">Race Phase</strong> è il primo input che il Race Engineer usa per decidere la strategia. Il modello rileva automaticamente la fase corrente della gara (partenza, stint iniziale, finestra pit, gestione centrale, attacco finale, ultimi giri, neutralizzazione, transizione meteo) e assegna a ciascuna fase un set di pesi che modificano l'importanza relativa di ogni fattore decisionale. In pratica: la fase gara determina <strong className="text-muted-foreground">quanto conta</strong> ciascun componente — degrado gomme, perdita per traffico, posizione in pista, penalità di rischio e opportunità da neutralizzazione — nel calcolo della strategia consigliata, del ranking delle alternative e del verdetto finale. Ad esempio, nella fase <em>Ultimi giri</em> il peso della posizione in pista sale a 1.4× e quello del degrado scende a 0.8×, rendendo il modello più aggressivo nel proteggere la posizione; in fase <em>Neutralizzazione</em> il peso dell'opportunità di pit sale a 1.5× favorendo soste opportunistiche. La fase viene rilevata dai dati reali e non è modificabile manualmente.
                </p>
              </div>
            </div>
