      ...
      <main className="max-w-7xl mx-auto px-6 py-8 space-y-8">
        ...
        {!sessionKey && (
          <section className="relative overflow-hidden rounded-2xl border border-border/60 px-6 sm:px-10 py-10 sm:py-14 card-premium">
            ...
            {/* Simulated telemetry background — animated */}
            <svg
            ...
            >
              <defs>
                ...
                {/* One tile = 1200 wide. Render twice side-by-side, then translate -1200 to loop. */}
                <symbol id="telemetryTile" viewBox="0 0 1200 400" width="1200" height="400" preserveAspectRatio="none">
                  {/* Horizontal grid */}
                  {[40, 110, 180, 250, 320].map((y) => (
                    <line key={`h${y}`} x1="0" x2="1200" y1={y} y2={y} stroke="hsl(var(--foreground))" strokeOpacity="0.08" strokeDasharray="3 6" />
                  ))}
                  {/* Vertical grid */}
                  {[150, 300, 450, 600, 750, 900, 1050].map((x) => (
                    <line key={`v${x}`} x1={x} x2={x} y1="20" y2="360" stroke="hsl(var(--foreground))" strokeOpacity="0.06" />
                  ))}
                  {/* Speed trace — endpoints match (y=80 at x=0 and x=1200) for seamless loop */}
                  <path
                    d="M0,80 L80,55 L140,60 L180,200 L230,210 L290,70 L360,50 L420,55 L460,230 L520,240 L580,90 L660,55 L720,60 L770,250 L820,260 L880,80 L960,55 L1040,60 L1100,210 L1160,210 L1200,80"
                    fill="none"
                  ...
                  {/* Throttle area */}
                  <path
                    d="M0,170 L80,150 L140,150 L180,300 L230,300 L290,160 L360,150 L420,150 L460,310 L520,310 L580,170 L660,150 L720,150 L770,320 L820,320 L880,170 L960,150 L1040,150 L1100,300 L1160,300 L1200,170 L1200,360 L0,360 Z"
              ...
              {/* Scrolling group: two tiles side-by-side, translated from 0 to -1200 */}
              <g className="telemetry-scroll">
                <use href="#telemetryTile" x="0" y="0" />
                <use href="#telemetryTile" x="1200" y="0" />
              </g>

              {/* Live cursor — fixed position, pulsing */}
              <line
                x1="980" x2="980" y1="20" y2="360"
                stroke="hsl(var(--f1-red-glow))"
                strokeOpacity="0.55"
                strokeWidth="1"
                strokeDasharray="3 4"
              ...
              />
              <circle cx="980" cy="80" r="4" fill="hsl(var(--f1-red-glow))" className="telemetry-cursor-dot" />
