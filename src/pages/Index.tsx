...
export default function Index() {
        ...
        if (willBeSingle && (sessionType === "Race" || sessionType === "Sprint")) {
          ...
          try {
            ...
            const vre = computeVirtualRaceEngineer(
              ...
              diaryForVre, cumDevForVre, vreScenario, vreScenarioLap,
            );
            setVreResult(vre);
          } catch { /* optional */ }
          setLoadingVre(false);
  ...
  const handleRemoveDriver = useCallback((driverNumber: number) => {
    ...
    setDiaryEvents([]);
    setVreResult(null); vreArgsRef.current = null; setVreRiskMode("BALANCED"); setVreScenario("REAL_CONTEXT"); setVreScenarioLap(null);
  }, []);
